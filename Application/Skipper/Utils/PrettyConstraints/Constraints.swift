...
public enum Constraints {
    case top(to: Constrainable,
             attribute: YAxisAttribute,
             constant: CGFloat = 0,
             multiplier: CGFloat = 1,
             equality: NSLayoutConstraint.Relation = .equal)

    case bottom(to: Constrainable,
                attribute: YAxisAttribute,
                constant: CGFloat = 0,
                multiplier: CGFloat = 1,
                equality: NSLayoutConstraint.Relation = .equal)

    case leading(to: Constrainable,
                 attribute: XAxisAttribute,
                 constant: CGFloat = 0,
                 multiplier: CGFloat = 1,
                 equality: NSLayoutConstraint.Relation = .equal)

    case trailing(to: Constrainable,
                  attribute: XAxisAttribute,
                  constant: CGFloat = 0,
                  multiplier: CGFloat = 1,
                  equality: NSLayoutConstraint.Relation = .equal)
    ...
    case right(to: Constrainable,
               attribute: XAxisAttribute,
               constant: CGFloat = 0,
               multiplier: CGFloat = 1,
               equality: NSLayoutConstraint.Relation = .equal)

    case width(to: Constrainable? = nil,
               attribute: DimensionAttribute? = nil,
               constant: CGFloat = 0,
               multiplier: CGFloat = 1,
               equality: NSLayoutConstraint.Relation = .equal)

    case height(to: Constrainable? = nil,
                attribute: DimensionAttribute? = nil,
                constant: CGFloat = 0,
                multiplier: CGFloat = 1,
                equality: NSLayoutConstraint.Relation = .equal)

    case centerX(to: Constrainable,
                 attribute: XAxisAttribute,
                 constant: CGFloat = 0,
                 multiplier: CGFloat = 1,
                 equality: NSLayoutConstraint.Relation = .equal)

    case centerY(to: Constrainable,
                 attribute: YAxisAttribute,
                 constant: CGFloat = 0,
                 multiplier: CGFloat = 1,
                 equality: NSLayoutConstraint.Relation = .equal)
